            ...
            <div className={styles.bg_purple}>
                <div className={styles.stars}>
                    ...
                    <div className={styles.central_body}>
                        <img className={styles.image_404} src="../Group 500.svg" alt="500" width="300px" />
                        <button onClick={() => router.back()} className={`btn btn-outline ${styles.btn_go_home}`} >GO BACK HOME</button>
                    </div>
