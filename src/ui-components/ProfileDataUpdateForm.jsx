...
export default function ProfileDataUpdateForm(props) {
  const {
    id: idProp,
    profileData: profileDataModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = profileDataRecord
      ? { ...initialValues, ...profileDataRecord }
      : initialValues;
  ...
  const [profileDataRecord, setProfileDataRecord] =
    React.useState(profileDataModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(ProfileData, idProp)
        : profileDataModelProp;
      setProfileDataRecord(record);
    };
    queryData();
  }, [idProp, profileDataModelProp]);
  React.useEffect(resetStateValues, [profileDataRecord]);
  const validations = {
    name: [],
    infiction_username: [],
    email: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            ProfileData.copyOf(profileDataRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "ProfileDataUpdateForm")}
      {...rest}
    >
      <TextField
        label="Name"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || profileDataModelProp)}
