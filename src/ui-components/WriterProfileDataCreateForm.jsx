...
export default function WriterProfileDataCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new WriterProfileData(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "WriterProfileDataCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
